...
export class Fx {
  ...
  static getMixColor(color1, color2, percentage) {
    let r0 = Math.floor(color1 & (0xff0000 / 0x10000)),
      g0 = Math.floor(color1 & (0x00ff00 / 0x100)),
      b0 = Math.floor(color1 & 0x0000ff);
    let r1 = Math.floor(color2 & (0xff0000 / 0x10000)),
      g1 = Math.floor(color2 & (0x00ff00 / 0x100)),
      b1 = Math.floor(color2 & 0x0000ff);
      let r = Math.floor((r1 - r0) * percentage + r0),
      g = Math.floor((g1 - g0) * percentage + g0),
      b = Math.floor((b1 - b0) * percentage + b0)
...
const fx_inside = {
  ...
  // The following presets are available for reference https://eaMath.sings.net/
  // 以下预设可参考 https://eaMath.sings.net/
